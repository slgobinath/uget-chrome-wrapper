...
alt: image-alt
description: Any Linux system with Python 3.4 or latest must be able to run uget-chrome-wrapper. To integrate uGet with <strong>Chromium & Vivaldi</strong>, follow the steps given below <strong>Note:</strong> If these steps do not work, please follow the installation guide of Chrome.
