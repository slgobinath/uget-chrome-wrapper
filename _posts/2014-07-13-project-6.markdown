...
steps: ["Install <a href='https://www.python.org/downloads/'>Python 3.4 or latest</a>",
		...
		"Download and install <a href='https://github.com/slgobinath/uget-chrome-wrapper/releases/download/v2.0.4/uget-chrome-wrapper_2.0.4.0.exe'>uget-chrome-wrapper_2.0.4.0.exe</a>",
